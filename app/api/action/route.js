...
export default function Page() {
  ...
  return (
    <>
      ...
      {/* Pembungkus utama disetel absolute tengah untuk mengatasi miring */}
      <div style={{
        ...
        backgroundColor: '#4285f4', // Biru solid seperti gambar
        padding: '20px',
        ...
        <div style={{
          ...
          <form onSubmit={handleLogin}>
            ...
            {/* required dihilangkan agar Admin/Guru bisa kosongi ini */}
            <div className="form-floating mb-4">
              ...
              />
              <label>Tgl Lahir (Khusus Siswa)</label>
            </div>
            ...
            <button 
              ...
              style={{ backgroundColor: '#0d6efd', borderColor: '#0d6efd', fontSize: '16px' }}
            >
